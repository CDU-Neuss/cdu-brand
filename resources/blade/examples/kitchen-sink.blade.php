...
<body class="p-8 space-y-16">
    ...
    <section>
        ...
        <x-cdu::cta title="CDU Shop" :links="[['href' => '/shop', 'text' => 'Zum Shop', 'isButton' => true], ['href' => '/info', 'text' => 'Mehr erfahren']]">
            Weit hinten, hinter den Wortbergen, fern der Länder Vokalien und Konsonantien leben die Blindtexte.
        </x-cdu::cta>
    </section>
    ...
    <section>
        <h2>Countdown</h2>
        <x-cdu::countdown target-date="2028-01-01 00:00:00" event="bis zum großen Event" :labels="['days' => 'Tage', 'hours' => 'Stunden', 'minutes' => 'Minuten', 'seconds' => 'Sekunden']" />
    </section>
